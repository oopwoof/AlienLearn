...
| **一次完整的问题归因**：73.3% 的诊断准确率，翻完 trace 发现错的不是模型，是我自己的评分标准 | [第四轮迭代记录](#五次真实的迭代记录) · `eval/out/evidence-04-pedagogy-aligned.md` |
| **为什么我不把留出集也刷到 100%** | 同上，第四轮最后三段 |
| **一个我自己踩到的坑**：temperature=0 不等于确定性，10 条样本的指标重跑会波动 10 个点 | 同上，[第五轮](#五次真实的迭代记录) |
